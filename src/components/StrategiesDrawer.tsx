...
import { Target, Plus, X, Rocket } from 'lucide-react';
          ...
          <Card>
            ...
            <CardContent>
              {savedConfigs.length === 0 && !supabaseLoading ? (
                <EnhancedEmptyState
                  icon={Rocket}
                  title="Nessuna strategia salvata"
                  description="Crea la tua prima strategia personalizzata configurando i parametri di investimento nel dashboard principale."
                  action={{
