    ...
    const loadStrategyDetail = async () => {
      ...
      try {
        ...
        const actualTrades: ActualTrade[] = (tradesData || []).map((trade: any) => ({
          ...
          day: trade.day,
          option_sold_date: trade.option_sold_date,
          expiration_date: trade.expiration_date,
          trade_date: trade.trade_date,
          btc_amount: trade.btc_amount !== null ? Number(trade.btc_amount) : null,
          fill_price_usd: trade.fill_price_usd !== null ? Number(trade.fill_price_usd) : null,
          strike_price: trade.strike_price !== null ? Number(trade.strike_price) : undefined,
          trade_type: trade.trade_type,
          option_status: trade.option_status || 'filled',
          premium_received_usdt: trade.premium_received_usdt !== null ? Number(trade.premium_received_usdt) : undefined,
